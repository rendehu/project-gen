...
public class CodeGenMain {
    ...
    public static void main(String[] args) {
        ...
        pathMap.put(OutputFile.mapper, ${camelProjectName}ParentPath + "${group}-${projectName}-persistence/src/main/java/${groupPackagePath}/persistence/mapper/");
        pathMap.put(OutputFile.entity, ${camelProjectName}ParentPath + "${group}-${projectName}-persistence/src/main/java/${groupPackagePath}/persistence/entity/");
        pathMap.put(OutputFile.mapperXml, ${camelProjectName}ParentPath + "${group}-${projectName}-persistence/src/main/resources/mapper/");
